...
//     // App badge functionality removed due to discontinued package
...
class NotificationService {
  static final StreamController<int> notificationsNumberStream = StreamController<int>.broadcast();
  static const String notificationsListKey = 'notifications_list';
  
  static void triggerNotificationCountStream() {
    // Stub implementation
  }
  
  static void handleClickOnNotification(Map<String, dynamic> data, dynamic tbContext) {
    // Stub implementation
  }
  
  static void clearNotificationBadgeCount() {
    // Stub implementation
  }
  
  static void decreaseNotificationBadgeCount(int id) {
    // Stub implementation
  }
}
